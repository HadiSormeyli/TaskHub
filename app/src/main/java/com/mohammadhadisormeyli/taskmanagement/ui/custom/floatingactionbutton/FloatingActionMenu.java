package com.mohammadhadisormeyli.taskmanagement.ui.custom.floatingactionbutton;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = ScreenUtils.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = ScreenUtils.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = ScreenUtils.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = ScreenUtils.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = ScreenUtils.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = ScreenUtils.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = ScreenUtils.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = ScreenUtils.dpToPx(getContext(), 3f);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mIcon == null) {
            mIcon = ContextCompat.getDrawable(context, R.drawable.ic_add);
        }
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = ScreenUtils.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = ScreenUtils.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = ScreenUtils.dpToPx(getContext(), mMenuShadowYOffset);
        }
        ...
        mImageToggle.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(getContext(), R.color.pure_white)));

        addView(mMenuButton, generateDefaultLayoutParams());
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int menuButtonTop = openUp
                ...
                : getPaddingTop();
        int menuButtonLeft = buttonsHorizontalCenter - mMaxButtonWidth / 2;
        ...
        int imageLeft = menuButtonLeft + mMaxButtonWidth / 2 - mImageToggle.getMeasuredWidth() / 2;
        ...
        for (int i = mButtonsCount - 1; i >= 0; i--) {
            ...
            int childX = menuButtonLeft + mMaxButtonWidth / 2 - fab.getMeasuredWidth() / 2;
            ...
            if (label != null) {
                int labelsOffset = (mUsingMenuLabel ? mMaxButtonWidth / 4 : fab.getMeasuredWidth() / 4) + mLabelsMargin;
    ...
    protected LayoutParams generateDefaultLayoutParams() {
        return new ConstraintLayout.LayoutParams(MarginLayoutParams.WRAP_CONTENT,
