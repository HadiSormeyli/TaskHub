...
import com.mohammadhadisormeyli.taskmanagement.databinding.FilePickerBinding
import com.mohammadhadisormeyli.taskmanagement.ui.custom.filepicker.adapter.ItemAdapter
import com.mohammadhadisormeyli.taskmanagement.ui.custom.filepicker.data.model.Media
import com.mohammadhadisormeyli.taskmanagement.ui.custom.filepicker.data.repository.FilesRepository
 ...
 * <pre>
 *    com.mohammadhadisormeyli.taskmanagement.ui.custom.filepicker.FilePicker.Builder([Context]).buildAndShow()
 * </pre>
 */
...
//        if (!com.mohammadhadisormeyli.taskmanagement.ui.custom.filepicker.extension.hasPermission(readStoragePermission)) {
...
//        }
    ...
    private fun getRequiredPermissionByType(): String {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            return when (fileType) {
                ...
                FileType.ALL -> Manifest.permission.READ_MEDIA_IMAGES
            }
        }
    ...
    companion object {
        ...
        var DEFAULT_ACCENT_COLOR = Color.parseColor("#3d5afe")
        const val DEFAULT_TITLE = "Choose File"
        var DEFAULT_TITLE_TEXT_COLOR = DEFAULT_ACCENT_COLOR
